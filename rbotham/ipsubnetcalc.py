...
class SubnetCalc(object):
    ...
    def convert_to_binary(self):
        ...
        hostbits = bin_mask1.count('0') + bin_mask2.count('0') + bin_mask3.count('0') + bin_mask4.count('0');
        print "host bits are", hostbits, "\n"

        mask_bits = (32 - hostbits);
        print "mask bits are ", mask_bits, "\n"
